...
// Break the problem down into single utility functions first. We use the following utils
// 1. `checkRe` - matches a string against a regex word. Returns boolean
// 2. `filter` - filters an array of objects based on a property and boolean function
// 3. `sum` - sums total values of an object property in an array
...
// Check magic (example)
// let checkMagic = partialRight(checkRe, 'magic')
...
// let totalSiteByProp = (arr, param, prop) => {
//   return sum(filter(arr, 'site', partialRight(checkRe, param)), prop)
// }

// Returns a function which awaits an array of objects to then sum the prop based on the url text matching the site url
