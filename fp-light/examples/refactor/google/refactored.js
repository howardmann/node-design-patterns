let data = [
  {
    _id: "59f9ae14706c4779a96a091b",
    updatedAt: "2017-11-01T11:28:23.662Z",
    createdAt: "2017-11-01T11:20:52.125Z",
    post: {
      social: {
        vk: {
          shares: 0
  ...
  {
    _id: "59f9ae14706c4779a96a091e",
    updatedAt: "2017-11-01T11:28:23.732Z",
    createdAt: "2017-11-01T11:20:52.156Z",
    post: {
      social: {
        vk: {
          shares: 0
  ...
  {
    _id: "59f9ae14706c4779a96a0920",
    updatedAt: "2017-11-01T11:28:23.745Z",
    createdAt: "2017-11-01T11:20:52.159Z",
    post: {
      social: {
        vk: {
          shares: 0
  ...
  {
    _id: "59f9ae14706c4779a96a092b",
    updatedAt: "2017-11-01T11:28:23.809Z",
    createdAt: "2017-11-01T11:20:52.243Z",
    post: {
      social: {
        vk: {
          shares: 0
  ...
  {
    _id: "59f9ae14706c4779a96a092c",
    updatedAt: "2017-11-01T11:28:23.826Z",
    createdAt: "2017-11-01T11:20:52.249Z",
    post: {
      social: {
        vk: {
          shares: 0
  ...
  {
    _id: "59f9ae14706c4779a96a092d",
    updatedAt: "2017-11-01T11:28:23.823Z",
    createdAt: "2017-11-01T11:20:52.252Z",
    post: {
      social: {
        vk: {
          shares: 0
      ...
      mainImage: "https://s2.reutersmedia.net/resources/r/?m=02&d=20171101&t=2&i=1207881497&w=&fh=545px&fw=&ll=&pl=&sq=&r=LYNXMPEDA02RH",
      domainRank: 408,
      text: "LONDON (Reuters) - The aggregate value of all cryptocurrencies hit a record high of around $184 billion on Wednesday, according to industry website Coinmarketcap, making their reported market value worth around the same as that of Goldman Sachs and Morgan Stanley combined.\nA copy of bitcoin standing on PC motherboard is seen in this illustration picture, October 26, 2017. Picture taken October 26, 2017. REUTERS/Dado Ruvic The new peak came as the biggest and best-known cryptocurrency, bitcoin, hit a record high of more than $6,500. That took its own “market cap” - its price multiplied by the number of coins that have been released into circulation - to a record high just shy of $110 billion.\nThe latest surge in bitcoin - which has seen an eye-watering increase of almost 800 percent in the past 12 months - was driven by news on Tuesday that CME Group, the world’s largest derivative exchange operator, would launch bitcoin futures in the fourth quarter of the year.\nThe announcement was seen as a major step in the digital currency’s path toward legitimacy and mainstream financial adoption.\nThe second-most valuable cryptocurrency Ether - sometimes known as “Ethereum”, after the project behind it - was trading slightly down on the day at $302 per coin, having hit a record high of more than $410 in June.\nReporting by Jemima Kelly; Editing by Dhara Ranasinghe\n ...",
      crawled: "2017-11-01T13:16:54.000+02:00",
      title: "Cryptocurrencies' total value hits record high as bitcoin blasts above $6,500",
      published: "2017-11-01T07:28:00.000+02:00",
      author: "Jemima Kelly",
      url: "http://omgili.com/ri/.wHSUbtEfZRtKw217TY9P0ZJCnfITvC0m30sCHr2utYTkprPTjFAhVGACBG.h9DMa2QdTRjUMmQeL8I5bT83N9DnBwrvLjP_FoYtCX7FSujphTQ1Fpgw8E_L1c4RM22XIZoI2iALAIC35czhYOI6Q_4BMrb8seyoLOTIYg_5WFaSTxxOfoazp5jl.JxvmXk3r6JsNqdaJLQJ8d0UoVNoZw--",
      site: "reuters.com",
      uuid: "fad3731484a504f3aa0b1261f387dd4d21131ce5"
    },
    topic: [
      "cryptocurrency",
      "ethereum"
  ...
  {
    _id: "59f9ae14706c4779a96a092e",
    updatedAt: "2017-11-01T11:28:23.854Z",
    createdAt: "2017-11-01T11:20:52.273Z",
    post: {
      social: {
        vk: {
          shares: 1
  ...
  {
    _id: "59f9ae14706c4779a96a0937",
    updatedAt: "2017-11-01T11:28:23.872Z",
    createdAt: "2017-11-01T11:20:52.326Z",
    post: {
      social: {
        vk: {
          shares: 0
      ...
      mainImage: "http://bitcoinist.com/wp-content/uploads/2017/10/confideal-ecosystem-cover.jpg",
      domainRank: null,
      ...
      crawled: "2017-11-01T01:36:52.012+02:00",
      title: "Confideal - More Than Just the Sum of Its Parts - Bitcoinist.com",
      published: "2017-10-31T21:45:00.000+02:00",
      author: "Jeff Francis",
      url: "http://omgili.com/ri/_0JOtn.4SCpu2xhlqzh54Chnaqr8MS1Gdr1D6bTCFBEPjyPMoEev3ir_fPjeR5Fb",
      site: "bitcoinist.com",
      uuid: "056b343437642caea6ccb3bd78d4cebedde592dc"
    },
    topic: [
      "cryptocurrency",
      "ethereum"
  ...
  {
    _id: "59f9ae14706c4779a96a0947",
    updatedAt: "2017-11-01T11:28:23.894Z",
    createdAt: "2017-11-01T11:20:52.445Z",
    post: {
      social: {
        vk: {
          shares: 0
  ...
  {
    _id: "59f9ae14706c4779a96a094c",
    updatedAt: "2017-11-01T11:28:23.937Z",
    createdAt: "2017-11-01T11:20:52.485Z",
    post: {
      social: {
        vk: {
          shares: 0
...
// Stubs
let google = {}
google.analyze = (text) => Promise.resolve({
  documentSentiment: {
...
let dbClient = {}
dbClient.updateSentimentScore = (id, score) => Promise.resolve({id, score, success: 'ok'})
dbClient.getAll = () => Promise.resolve(data)

// Imperative
google.pollSentiment = () => {
  return new Promise(resolve => {
    dbClient.getAll()
      .then(data => data.filter(o => !o.documentSentiment)) // filter out docs already with sentiments
      .then(data => data.map(o => _.pick(o, ['post.title', '_id']))) // pick out the title and id only
      .then(data => {
        let promiseArr = data.map(o => {
          let text = _.get(o, 'post.title')
          return google.analyze(text)
            .then(resp => {
              console.log(`New sentiment analyzed: score of ${resp.documentSentiment.score} for ${text}`);
      ...
      }) // analyze the text via promise API and pass a new object through with updated score fields
      .then(data => {
        let promiseArr = data.map(o => {
          let score = _.get(o, 'documentSentiment.score')
          let id = o._id

          return dbClient.updateSentimentScore(id, score)
            .then(resp => {
              return Object.assign({ ...o
              }, resp)
            })
        ...
        return Promise.all(promiseArr)
      }) // update the document score by passing it the id and score and return resolved response
      .then(data => {
...
// google.pollSentiment()
//   .then(resp => {
//     resp // No more results, totalResults: 8
//   })
...
let logSentiment = (o) => console.log(`New sentiment analyzed: score of ${o.documentSentiment.score} for ${o.post.title}`);

let filterIdTextArr = pipe(
  _.partialRight(_.filter, o => !o.documentSentiment),
